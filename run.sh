...
docker run -dit --restart always --name docker-host-shell-tunnel --volume $INPUT_FIFO:$INPUT_FIFO --volume $OUTPUT_FIFO:$OUTPUT_FIFO -p 1801-1802:1801-1802 docker-host-shell-tunnel
